    ...
    return (
      <>
        ...
        <div className="productEdit">
          ...
          <form
            id="editProduct"
            className="productEdit__details"
          ...
          >
            <div className="productEdit__description">
              ...
              <textarea
                ...
                onChange={event =>
                  this.formUpdate(event.target.value, event.target.name)
                }
              />
            </div>
            <div className="productEdit__info">
              <div>
                <div>
                  ...
                  <input
                    name="orderBy"
                    value={this.state.product.orderBy}
                    onChange={event =>
                      this.formUpdate(event.target.value, event.target.name)
                    }
                  />
                ...
                <div>
                  ...
                  <input
                    name="refNumber"
                    value={this.state.product.refNumber}
                    onChange={event =>
                      this.formUpdate(event.target.value, event.target.name)
                    }
                  />
              ...
              <div>
                <div>
                  ...
                  <input
                    name="orderDate"
                    value={this.state.product.orderDate}
                    onChange={event =>
                      this.formUpdate(event.target.value, event.target.name)
                    }
                  />
                ...
                <div>
                  ...
                  >
                    ...
                    <option
                      value={JSON.stringify({ city: "Paris", country: "FRA" })}
                    >
                      Paris, FRA
                    </option>
                  </select>
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="productEdit__switch--container">
                    ...
                    <Switch
                      name="inStock"
                      onChange={event => this.formUpdate(event)}
              ...
              <div>
                <section>
                  <h5>CATEGORIES</h5>
                  <textarea
                    className="productEdit__categories"
                    name="categories"
                    value={this.printCategories()}
                    onChange={event =>
                      this.formUpdate(event.target.value, event.target.name)
                    }
                  />
