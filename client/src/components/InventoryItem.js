...
class InventoryItem extends React.Component {
    ...
    render() {
        ...
        if (this.state.displayRemove) {
            removeButton = <button className="inventory__remove" onClick={console.log(this.props.product.id)}>Remove</button>;
        } else {
            removeButton = <button className="inventory__remove--hidden" onClick={this.delete}>Remove</button>
        }
        return (
            <>
            <tr>
